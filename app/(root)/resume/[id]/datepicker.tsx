...
const DatePicker = forwardRef<HTMLDivElement, Props>(({ selectedDate, onDateChange }, ref) => {
  ...
  return (
    <div className="relative" ref={ref}>
      <input
        className="px-4 block w-1/2 md:w-10/12 rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none"
        type="text"
        readOnly
