...
import { Activity, ChevronLeft, Layers, PersonStanding, Ruler, SquareChartGantt } from "lucide-react";


const DrivingLicense = ({selectedSection,setSelectedSection,setShowPreview,selected}) =>{
...
<p className="text-black">Motorbikes</p>
  ...
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    AM <Ruler /> {"<"} 50 cm³ {"<"} <Activity /> {"<"} 45km/h {"<"} 4kW 16+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    A1 <Ruler /> {"<"} 125 cm³ {"<"} <Activity /> {"<"} 11kW - 0.1kW/kg 16+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    A2 <Ruler /> {"<"}  35 kW - 0.2 kW/kg {"<"} <Activity /> {"<"}  18+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    A <Ruler /> {"<"}  35 kW - 0.2 kW/kg {"<"} <Activity /> {"<"}  20/24+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    B1 <Ruler /> {"<"}   15 kW {"<"} <Activity /> {"<"} 400/500 kg {"<"}  16+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    B <Ruler /> {"<"}  3500 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 18+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    BE <Ruler /> {"<"}  3500 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 18+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    C1 <Ruler /> {"<"}  7500 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 18+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    C1E <Ruler /> {"<"}  12000 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 18+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    C <Ruler /> {"<"}  3500 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 21+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    CE <Ruler /> {"<"}  3500 kg <PersonStanding /> max. 8+1 <Layers /> {"<"} 750 kg <SquareChartGantt /> 21+
...
<div className="flex items-center">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    D1 <Ruler /> {"<"}  max. 16+1 <PersonStanding /> max. 8m <Layers /> {"<"} 750 kg <SquareChartGantt /> 21+
...
<div className="flex items-center my-2">
  ...
  />
  <div className="text-black flex bg-slate-200 p-4 text-2xl">
    D1E <Ruler /> {"<"}  max. 16+1 <PersonStanding /> max. 8m <Layers /> {"<"} 750 kg <SquareChartGantt /> 21+
