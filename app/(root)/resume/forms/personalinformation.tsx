        ...
        <div className="p-6 space-y-4 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-lg font-semibold text-gray-800">
            ...
            <span className="font-light">
              {dateFormatter(personalInformation.dob)}
            </span>
          </p>
          <p className="text-lg font-semibold text-gray-800">
            Nationality :{" "}
          ...
          <p className="text-lg font-semibold text-gray-800">
            Address :{" "}
            <span className="font-light capitalize">
              {personalInformation.add1} {personalInformation.add2}{" "}
              {personalInformation.code} {personalInformation.city}{" "}
          ...
          {personalInformation.email && (
            <p className="text-lg font-semibold text-gray-800">
              Email Address :{" "}
              <span className="font-light">{personalInformation.email}</span>
            </p>
          )}
          ...
          {personalInformation.contact && (
            <p className="text-lg font-semibold text-gray-800">
              Contact Number:{" "}
              <span className="font-light">{personalInformation.contact}</span>
            </p>
          )}
          {personalInformation.about && (
            <p className="text-lg font-semibold text-gray-800">
              Main activities and responsibilities :{" "}
              <span className="font-light">{personalInformation.about}</span>
            </p>
          )}
